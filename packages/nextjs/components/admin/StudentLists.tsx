    ...
    <section className="flex flex-col w-full py-6">
      <main className="flex flex-col w-full gap-7">
        <div className="flex flex-col">
          <h1 className="text-xl font-bold uppercase text-color2 md:text-2xl">Students List</h1>
          <h4 className="text-lg tracking-wider text-color2"> List of {data.length} students in your programme</h4>
          <p className="text-sm text-color2">
            To upload student&apos;s list,{" "}
          ...
          <div className="flex flex-col w-full mt-4 text-red-600">
            ...
            <ol className="text-xs text-red-600 list-decimal list-inside">
              <li>
                Upload student&apos;s list from here:{" "}
